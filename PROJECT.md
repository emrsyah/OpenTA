...
Similar to [alphaXiv](https://www.alphaxiv.org/) and [SciSpace](https://scispace.com/), Open TA Tel-Yu aims to create a collaborative space for academic research specifically for the Telkom University community.
...
- **User Profiles**: Alumni profiles showcasing publications and research interests
